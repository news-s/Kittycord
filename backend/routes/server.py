...
from database.servers import get_server_by_link, join_server, create_server, delete_server, get_owner_id
...
async def add_server(data: AddServer) -> AddServerResponse:
    ...
    res = create_server(int(user_id), data.server_name, "random_invite_link") # TODO make invite link random
...
@router.post("/remove_server", status_code=202)
