...
<nav class="flex flex-col items-center gap-2 py-3 h-screen w-[72px] bg-white/60 border-r border-[#fbcfe8]/50">
    ...
    {#each servers as server, id}
        <a href={`server?id=${id}`} title={id} class="flex items-center justify-center w-12 h-12 rounded-full hover:rounded-xl transition-all duration-200" style="background: linear-gradient(135deg, #f9a8d4 0%, #ec4899 100%);">
